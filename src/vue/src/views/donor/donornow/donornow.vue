            ...
            <el-form ref="form"  label-width="150px">
              <el-form-item label="项目">
               ...
               <el-form-item label="捐款金额(链克)">
                ...
                <el-button @click="payResult" type="warning" round>捐款结果</el-button>
...
export default {
  ...
  components: {
   ...
   methods: {
    ...
    payResult() {
       this.$http.get("/pay/getPayResult").then((res) => {
        alert(res.data.payStatus);
      },(err) => {
          alert("load getPayResult failed !");
      });
    }
  },
  computed:{
